#set(ANDROID_NDK /DATA/android/android-ndk-r5/)
#set(ANDROID_NDK_TOOLCHAIN_ROOT /WORK/cross/android-r5c-toolchain)
...
set( LINKER_FLAGS "-Wl,--fix-cortex-a8 -L\"${STL_LIBRARIES_PATH}\" -L\"${CMAKE_INSTALL_PREFIX}/libs/${ARMEABI_NDK_NAME}\" -fno-rtti -fno-exceptions" )
