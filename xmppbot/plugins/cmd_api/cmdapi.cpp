...
xcmdapi::CallBack(const char *jid)
{
    ...
    _chan_ = (gobee::__x_object *) x_session_channel_open2(
                    X_OBJECT(_sess_), "m.A");
    ...
    x_session_add_payload_to_channel(
                X_OBJECT(_chan_), _XS("110"), _XS("SPEEX"), MEDIA_IO_MODE_OUT,
                                     &hints);
    attr_list_clear(&hints);
#endif
...
___on_x_path_event(gobee::__x_object *obj)
{
    x_object *tmp;
    gobee::__x_object *_o =
            new ("http://jabber.org/protocol/commands", "command") gobee::__x_object();
    ENTER;
...
xcmdapi::xcmdapi()
{
    gobee::__x_class_register_xx(this, sizeof(xcmdapi),
                                 "http://jabber.org/protocol/commands", "command");
    cmd_bus_listener.lstnr.on_x_path_event = (void(*)(void*)) &___on_x_path_event;
    x_path_listener_add("/", (x_path_listener_t *) (void *) &cmd_bus_listener);
